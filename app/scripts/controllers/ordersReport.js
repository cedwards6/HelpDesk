angular.module('helpDesk').controller('orderStatsCtrl', function ($state, $rootScope, $scope, $uibModal, ordersReportService, $localStorage, $sessionStorage, $q, $interval) {


        $scope.currentVAI = [];
        $scope.currentPortal = [];

        $scope.lastDayPortalV4 = [];
    ...
    function initorderStatsCtrl() {
        ...
        ordersReportService.getLastDay().then(function(response){
            if (angular.isDefined(response.data)){
                ...
                $scope.lastDayPortalV4 = response.data.RowSet.Row[0].PortalV4;
                $scope.lastDayTotal = $scope.lastDayTotal + $scope.lastDayPortalV4;
                ...
                $scope.lastDayPortalV4Pct = $scope.lastDayPortalV4 / $scope.lastDayTotal * 100;
        ...
        ordersReportService.getMonth().then(function(response){
            if (angular.isDefined(response.data)) {
                $scope.mtdTotal = 0;
                $scope.mtdPortalV4 = response.data.RowSet.Row[0].PortalV4;
                $scope.mtdTotal = $scope.mtdTotal + $scope.mtdPortalV4;
                ...
                $scope.mtdPortalV4Pct = $scope.mtdPortalV4 / $scope.mtdTotal * 100;
        ...
        ordersReportService.getprvMonth().then(function(response){
            if (angular.isDefined(response.data)) {
                $scope.prvTotal = 0;
                $scope.prvPortalV4 = response.data.RowSet.Row[0].PortalV4;
                $scope.prvTotal = $scope.prvTotal + $scope.prvPortalV4;
                ...
                $scope.prvPortalV4Pct = $scope.prvPortalV4 / $scope.prvTotal * 100;
        ...
        ordersReportService.get3rdMonth().then(function(response){
            if (angular.isDefined(response.data)) {
                $scope.prv2Total = 0;
                $scope.prv2PortalV4 = response.data.RowSet.Row[0].PortalV4;
                $scope.prv2Total = $scope.prv2Total + $scope.prv2PortalV4;
                ...
                $scope.prv2PortalV4Pct = $scope.prv2PortalV4 / $scope.prv2Total * 100;
        ...
        ordersReportService.get4thMonth().then(function(response){
            if (angular.isDefined(response.data)) {
                $scope.prv3Total = 0;
                $scope.prv3PortalV4 = response.data.RowSet.Row[0].PortalV4;
                $scope.prv3Total = $scope.prv3Total + $scope.prv3PortalV4;
                ...
                $scope.prv3PortalV4Pct = $scope.prv3PortalV4 / $scope.prv3Total * 100;
        ...
        ordersReportService.get5thMonth().then(function(response){
            if (angular.isDefined(response.data)) {
                $scope.prv4Total = 0;
                $scope.prv4PortalV4 = response.data.RowSet.Row[0].PortalV4;
                $scope.prv4Total = $scope.prv4Total + $scope.prv4PortalV4;
                ...
                $scope.prv4PortalV4Pct = $scope.prv4PortalV4 / $scope.prv4Total * 100;
